...
class FlushAndGetHandoffCheckpointResponse(
    val indexName: String,
    val shardResponses: List<FlushAndGetHandoffCheckpointShardResponse>
) : ActionResponse(), ToXContentObject {

    constructor(inp: StreamInput) : this(
        inp.readString(),
        inp.readList(::FlushAndGetHandoffCheckpointShardResponse)
    )
